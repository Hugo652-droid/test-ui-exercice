...
test('visits the app root url', async ({ page }) => {
  //TODO: les test pour vous si le site se lance correctement

  await expect(page.locator('h1')).toHaveText('You did it!');
})

test('click me button', async ({ page }) => {
  //TODO: Créer un test qui clique sur le bouton "count"
...
test('explore pages', async ({page}) => {
  ...
  //TODO: Créer un test qui navigue vers la page "form", qui remplit le formulaire et le valide
